...
RSpec.describe CustomFormHelpers, type: :helper do
  let(:form_object) { instance_double("FormObject") } # rubocop:disable RSpec/VerifiedDoubleReference
  ...
  describe "#continue_button" do
    ...
    let(:template) { instance_double("template", params:) } # rubocop:disable RSpec/VerifiedDoubleReference
  ...
  describe "#i18n_hint" do
    let(:found_locale) { instance_double("locale") } # rubocop:disable RSpec/VerifiedDoubleReference
