...
RSpec.describe ConvictionType do
  ...
  describe "ConvictionType attributes" do
    ...
    context "when skip_length?" do
      ...
      context "when skip_length? is true" do
        ...
        it { expect(conviction_type.skip_length?).to be(true) }
      end
    end
  end
  ...
  describe "Conviction subtype attributes" do
    ...
    context "when CASHIERING_DISCHARGE_DISMISSAL" do
      ...
      it { expect(conviction_type.skip_length?).to be(true) }
      it { expect(conviction_type.relevant_order?).to be(false) }
      it { expect(conviction_type.no_drag_through?).to be(false) }
  ...
  describe "#schedule_18_applicable?" do
    ...
    context "when adult_prison_sentence" do
      ...
      it { expect(schedule_18_applicable).to be(true) }
    end
    ...
    context "when adult_service_detention" do
      ...
      it { expect(schedule_18_applicable).to be(false) }
    end
  end
end
