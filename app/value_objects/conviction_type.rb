class ConvictionType < ValueObject
  ...
  VALUES = [
    ...
    ADULT_CASHIERING_DISCHARGE_DISMISSAL_DISGRACE = new(:cashiering_discharge_ignominy_dismissal_disgrace,  parent: MILITARY, skip_length: true, calculator_class: Calculators::AdditionCalculator::StartPlusSixMonths),
