class ConvictionType < ValueObject
  ...
  VALUES = [
    ...
    YOUTH_DISQUALIFICATION             = new(:youth_disqualification,         parent: YOUTH_MOTORING, relevant_order: true, no_drag_through: true, calculator_class: Calculators::AdditionCalculator::PlusZeroMonthsDisqualification),
    ...
    ADULT_DISQUALIFICATION               = new(:adult_disqualification,               parent: ADULT_MOTORING, relevant_order: true, no_drag_through: true, calculator_class: Calculators::AdditionCalculator::PlusZeroMonthsDisqualification),
    ...
    ADULT_PENALTY_NOTICE                 = new(:adult_penalty_notice,                 parent: ADULT_MOTORING, skip_length: true, no_drag_through: false, calculator_class: Calculators::Motoring::Adult::PenaltyNotice),
