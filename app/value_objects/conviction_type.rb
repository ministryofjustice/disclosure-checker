class ConvictionType < ValueObject
  ...
  VALUES = [
    ...
    YOUTH_DISQUALIFICATION             = new(:youth_disqualification,         parent: YOUTH_MOTORING, relevant_order: true, no_drag_through: true, calculator_class: Calculators::AdditionCalculator::StartPlusZeroMonths),
    ...
    ADULT_DISQUALIFICATION               = new(:adult_disqualification,               parent: ADULT_MOTORING, relevant_order: true, no_drag_through: true, calculator_class: Calculators::AdditionCalculator::StartPlusZeroMonths),
