class ConvictionType < ValueObject
  ...
  VALUES = [
    ...
    ADULT_CASHIERING_DISCHARGE_DISMISSAL = new(:cashiering_discharge_dismissal,     parent: ADULT_MILITARY, skip_length: true, calculator_class: Calculators::AdditionCalculator::StartPlusTwelveMonths),
