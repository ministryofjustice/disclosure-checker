Feature: Adult Conviction
  ...
  Scenario Outline: Motoring disqualification with length
    ...
    Examples:
      ...
      | Disqualification | When did the ban start? | Was the length of the disqualification given in days, weeks, months or years? | What was the length of the disqualification? | 70            | This conviction was spent on 1 May 2023 |
